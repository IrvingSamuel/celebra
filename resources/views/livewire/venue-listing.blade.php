<div>
    <section class="bg-bg min-h-screen">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
            ...
            {{-- Filters Bar --}}
            <div class="bg-white rounded-card p-4 shadow-sm mb-8 flex flex-col sm:flex-row gap-4">
                {{-- Search --}}
                ...
                {{-- City Filter --}}
                @if($cities->count())
                    <select wire:model.live="city" class="bg-bg rounded-full px-4 py-2 text-sm text-text border-none focus:outline-none focus:ring-2 focus:ring-primary">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6" wire:loading.class="opacity-50">
                @forelse($venues as $venue)
                    <div class="bg-white rounded-card overflow-hidden shadow-sm hover:shadow-lg transition-shadow duration-300 group">
